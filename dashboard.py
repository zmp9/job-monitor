...
WEIGHT_LABELS = {
    ...
    "requirement_match": "resume skill named in the JD's requirements block",
    "requirement_miss": "JD requires a major/skill I don't have",
    ...
    "off_season": "Fall/Winter/Spring term when Summer is the target",
